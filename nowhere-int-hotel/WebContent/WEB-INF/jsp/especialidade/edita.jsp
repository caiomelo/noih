...
<head>
	...
	<title>PSF - Especialidade - edita</title>
</head>
<body>
	<form action="<c:url value="/especialidade/edita/${especialidade.id }"/>" method="post">
			<fieldset>
				<label for="edita_especialidade_nome" 
				<vraptor:hasErrors category="nome">class="vermelho"</vraptor:hasErrors>>Especialidade  </label> 
				<input id="edita_especialidade_nome" type="text" name="especialidade.nome" value="${especialidade.nome }" 

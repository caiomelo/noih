	<div class="title">Amostragem &gt;&gt; Novo</div><hr />
		<form action="<c:url value="/amostragem/novo" />" method="post">	
			<fieldset>
				<label for="cadastro_amostragem_propriedade"
				<vraptor:hasErrors category="propriedade">class="vermelho"</vraptor:hasErrors>>Propriedade</label>
				<select id="cadastro_amostragem_propriedade" name="amostragem.propriedade.id"
			...
			<fieldset>
				<label for="cadastro_amostragem_data"
					<vraptor:hasErrors category="data">class="vermelho"</vraptor:hasErrors>>Data</label> 
					<input id="cadastro_amostragem_data" type="text" name="amostragem.data" 
			...
			<fieldset>
				<label for="cadastro_amostragem_unidade_producao"
				<vraptor:hasErrors category="unidadeProducao">class="vermelho"</vraptor:hasErrors>>Unidade/Producao</label> 
				<input id="cadastro_amostragem_unidade_producao" type="text" 
			...
			<fieldset class="full">
				<label for="cadastro_amostragem_observacao">Observação</label>
				<textarea id="cadastro_amostragem_observacao" rows="10" cols="56" name="amostragem.observacao">${amostragem.observacao }</textarea> 
			</fieldset>
